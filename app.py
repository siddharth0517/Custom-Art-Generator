...
style = st.selectbox("Select a Style", ["None", "Van Gogh", "Cyberpunk", "Cubism", "Minimalist"])
if style != "None":
...
# Extend functionality: Add download button
from PIL import Image
import io

if st.button("Download Artwork"):
    buf = io.BytesIO()
    image.save(buf, format="PNG")
    buf.seek(0)
    st.download_button("Download Image", buf, file_name="artwork.png", mime="image/png")
